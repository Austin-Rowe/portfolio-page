...
class About extends Component {
    state = {  }
    render() { 
        const colorAboutPics = [
            {
                original: "https://s3.us-east-2.amazonaws.com/austin-rowe/action_color_1.JPG"
            },
            {
                original: "https://s3.us-east-2.amazonaws.com/austin-rowe/action_color_2.JPG"
            },
            {
                original: "https://s3.us-east-2.amazonaws.com/austin-rowe/action_color_3.JPG"
            }
        ]
        return ( 
